export class RpcClient {
     ...
     */
    get targets(): import("@appium/types").StringRecord;
     ...
     */
    waitForTarget(appIdKey: string, pageIdKey: string | number, force?: boolean): Promise<void>;
    /**
     *
     ...
     * @returns {Promise<any>}
     */
    send(command: string, opts?: Record<string, any>, waitForResponse?: boolean): Promise<any>;
    /**
     *
     * @param {string} command
     * @param {Record<string, any>} opts
     ...
     * @returns {Promise<any>}
     */
    sendToDevice(command: string, opts?: Record<string, any>, waitForResponse?: boolean): Promise<any>;
